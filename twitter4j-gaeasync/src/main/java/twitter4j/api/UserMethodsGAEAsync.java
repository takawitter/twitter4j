 ...
 */
public interface UserMethodsGAEAsync {
    /**
     ...
     */
	TwitterFuture<User> showUser(String screenName) throws TwitterException;
     ...
     */
	TwitterFuture<User> showUser(long userId) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<User>> lookupUsers(String[] screenNames) throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
	TwitterFuture<ResponseList<User>> lookupUsers(long[] ids) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<User>> searchUsers(String query, int page) throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
	TwitterFuture<ResponseList<Category>> getSuggestedUserCategories() throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
	TwitterFuture<ResponseList<User>> getUserSuggestions(String categorySlug) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<User>> getMemberSuggestions(String categorySlug) throws TwitterException;
     ...
     */
	TwitterFuture<ProfileImage> getProfileImage(String screenName, ProfileImage.ImageSize size) throws TwitterException;
     ...
     */
	TwitterFuture<PagableResponseList<User>> getFriendsStatuses(long cursor)
     ...
     * @since Twitter4J 2.0.9
     */
	TwitterFuture<PagableResponseList<User>> getFriendsStatuses(String screenName, long cursor)
            throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
	TwitterFuture<PagableResponseList<User>> getFriendsStatuses(long userId, long cursor)
            throws TwitterException;
     ...
     * @since Twitter4J 2.0.9
     */
	TwitterFuture<PagableResponseList<User>> getFollowersStatuses(long cursor)
            throws TwitterException;
     ...
     * @since Twitter4J 2.0.9
     */
	TwitterFuture<PagableResponseList<User>> getFollowersStatuses(String screenName, long cursor)
            throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
	TwitterFuture<PagableResponseList<User>> getFollowersStatuses(long userId, long cursor)
            throws TwitterException;
}
