 ...
 */
public interface LocalTrendsMethodsGAEAsync {
    /**
     ...
     */
	TwitterFuture<ResponseList<Location>> getAvailableTrends() throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
	TwitterFuture<ResponseList<Location>> getAvailableTrends(GeoLocation location) throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
	TwitterFuture<Trends> getLocationTrends(int woeid) throws TwitterException;
}
