 ...
 */
public interface TimelineMethodsGAEAsync {
    /**
     ...
     */
	TwitterFuture<ResponseList<Status>> getPublicTimeline() throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<Status>> getHomeTimeline() throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getHomeTimeline(Paging paging) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<Status>> getFriendsTimeline() throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<Status>> getFriendsTimeline(Paging paging) throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline(String screenName, Paging paging) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline(long userId, Paging paging) throws TwitterException;
     ...
     * @see <a href="http://dev.twitter.com/doc/get/statuses/user_timeline">GET statuses/user_timeline | dev.twitter.com</a>
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline(String screenName) throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline(long userId) throws TwitterException;
     ...
     * @see <a href="http://dev.twitter.com/doc/get/statuses/user_timeline">GET statuses/user_timeline | dev.twitter.com</a>
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline() throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
	TwitterFuture<ResponseList<Status>> getUserTimeline(Paging paging) throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
	TwitterFuture<ResponseList<Status>> getMentions() throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
	TwitterFuture<ResponseList<Status>> getMentions(Paging paging) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedByMe() throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedByMe(Paging paging) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedToMe() throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedToMe(Paging paging) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetsOfMe() throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetsOfMe(Paging paging) throws TwitterException;
     ...
     */
	TwitterFuture<ResponseList<Status>> getRetweetedToUser(String screenName, Paging paging)
     ...
     * @since Twitter4J 2.1.9
     */
	TwitterFuture<ResponseList<Status>> getRetweetedToUser(long userId, Paging paging)
            throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedByUser(String screenName, Paging paging)
            throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<ResponseList<Status>> getRetweetedByUser(long userId, Paging paging)
            throws TwitterException;
}
