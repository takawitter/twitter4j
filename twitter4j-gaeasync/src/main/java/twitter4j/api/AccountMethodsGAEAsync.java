 ...
 */
public interface AccountMethodsGAEAsync {
    /**
     ...
     */
    TwitterFuture<User> verifyCredentials() throws TwitterException;
     ...
     */
    TwitterFuture<RateLimitStatus> getRateLimitStatus() throws TwitterException;
     ...
     * @since Twitter4J 2.0.0
     */
    TwitterFuture<User> updateProfileColors(String profileBackgroundColor, String profileTextColor, String profileLinkColor, String profileSidebarFillColor, String profileSidebarBorderColor)
     ...
     */
    TwitterFuture<User> updateProfileImage(File image) throws TwitterException;
     ...
     */
    TwitterFuture<User> updateProfileImage(InputStream image) throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
    TwitterFuture<User> updateProfileBackgroundImage(File image, boolean tile)
            throws TwitterException;
     ...
     * @since Twitter4J 2.1.11
     */
    TwitterFuture<User> updateProfileBackgroundImage(InputStream image, boolean tile)
            throws TwitterException;
     ...
     */
    TwitterFuture<User> updateProfile(String name, String url, String location, String description)
            throws TwitterException;
     ...
     */
    TwitterFuture<AccountTotals> getAccountTotals() throws TwitterException;
     ...
     * @since Twitter4J 2.1.9
     */
    TwitterFuture<AccountSettings> getAccountSettings() throws TwitterException;
}
