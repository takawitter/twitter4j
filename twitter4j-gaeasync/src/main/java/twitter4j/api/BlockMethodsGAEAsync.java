 ...
 */
public interface BlockMethodsGAEAsync {
    /**
     ...
     */
    TwitterFuture<User> createBlock(String screenName) throws TwitterException;
     ...
     */
    TwitterFuture<User> createBlock(long userId) throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
    TwitterFuture<User> destroyBlock(String screen_name) throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
    TwitterFuture<User> destroyBlock(long userId) throws TwitterException;
     ...
     */
    TwitterFuture<Boolean> existsBlock(String screenName) throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
    TwitterFuture<Boolean> existsBlock(long userId) throws TwitterException;
     ...
     * @since Twitter4J 2.0.4
     */
    TwitterFuture<ResponseList<User>> getBlockingUsers() throws TwitterException;
     ...
     * @since Twitter4J 2.0.4
     */
    TwitterFuture<ResponseList<User>> getBlockingUsers(int page) throws TwitterException;
     ...
     * @since Twitter4J 2.0.4
     */
    TwitterFuture<IDs> getBlockingUsersIDs() throws TwitterException;
}
