 ...
 */
public interface TrendsMethodsGAEAsync {
    /**
     ...
     */
	TwitterFuture<Trends> getTrends() throws TwitterException;
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<Trends> getCurrentTrends() throws TwitterException;
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<Trends> getCurrentTrends(boolean excludeHashTags) throws TwitterException;
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<List<Trends>> getDailyTrends() throws TwitterException;
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<List<Trends>> getDailyTrends(Date date, boolean excludeHashTags)
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<List<Trends>> getWeeklyTrends() throws TwitterException;
     ...
     * @since Twitter4J 2.0.2
     */
	TwitterFuture<List<Trends>> getWeeklyTrends(Date date, boolean excludeHashTags)
            throws TwitterException;
}
