 ...
 */
public interface SavedSearchesMethodsGAEAsync {
    /**
     ...
     */
	TwitterFuture<List<SavedSearch>> getSavedSearches() throws TwitterException;
     ...
     * @since Twitter4J 2.0.8
     */
	TwitterFuture<SavedSearch> showSavedSearch(int id) throws TwitterException;
     ...
     * @since Twitter4J 2.0.8
     */
	TwitterFuture<SavedSearch> createSavedSearch(String query)
     ...
     * @since Twitter4J 2.0.8
     */
	TwitterFuture<SavedSearch> destroySavedSearch(int id)
            throws TwitterException;
}
