 ...
 */
public interface GeoMethodsGAEAsync {
    /**
     ...
     */
    TwitterFuture<ResponseList<Place>> searchPlaces(GeoQuery query) throws TwitterException;
     ...
     * @since Twitter4J 2.1.7
     */
    TwitterFuture<SimilarPlaces> getSimilarPlaces(GeoLocation location, String name, String containedWithin, String streetAddress) throws TwitterException;
     ...
     * @since Twitter4J 2.1.1
     */
    TwitterFuture<ResponseList<Place>> reverseGeoCode(GeoQuery query) throws TwitterException;

    /**
     * Find out more details of a place that was returned from the {@link twitter4j.api.GeoMethodsGAEAsync#reverseGeoCode(twitter4j.GeoQuery)} method.
     ...
     * @since Twitter4J 2.1.1
     */
    TwitterFuture<Place> getGeoDetails(String id) throws TwitterException;
     ...
     * @since Twitter4J 2.1.7
     */
    TwitterFuture<Place> createPlace(String name, String containedWithin, String token, GeoLocation location, String streetAddress)
