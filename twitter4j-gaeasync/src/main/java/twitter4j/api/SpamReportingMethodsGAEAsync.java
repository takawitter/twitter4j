 ...
 */
public interface SpamReportingMethodsGAEAsync {
     ...
     */
	TwitterFuture<User> reportSpam(long userId) throws TwitterException;
     ...
     * @since Twitter4J 2.1.0
     */
	TwitterFuture<User> reportSpam(String screenName) throws TwitterException;
}
