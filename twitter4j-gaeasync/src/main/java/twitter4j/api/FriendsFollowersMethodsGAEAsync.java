 ...
 */
public interface FriendsFollowersMethodsGAEAsync {
     ...
     */
	TwitterFuture<IDs> getFriendsIDs(long cursor) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<IDs> getFriendsIDs(long userId, long cursor) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<IDs> getFriendsIDs(String screenName, long cursor) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<IDs> getFollowersIDs(long cursor) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<IDs> getFollowersIDs(long userId, long cursor) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
	TwitterFuture<IDs> getFollowersIDs(String screenName, long cursor) throws TwitterException;
}
