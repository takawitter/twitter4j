 ...
 */
public interface StatusMethodsGAEAsync {
    /**
     ...
     */
    TwitterFuture<Status> showStatus(long id) throws TwitterException;
     ...
     * @since Twitter4J 2.0.1
     */
    TwitterFuture<Status> updateStatus(String status) throws TwitterException;
     ...
     */
    TwitterFuture<Status> updateStatus(StatusUpdate latestStatus) throws TwitterException;
     ...
     * @since 1.0.5
     */
    TwitterFuture<Status> destroyStatus(long statusId) throws TwitterException;
     ...
     */
    TwitterFuture<Status> retweetStatus(long statusId) throws TwitterException;
     ...
     * @since Twitter4J 2.0.10
     */
    TwitterFuture<ResponseList<Status>> getRetweets(long statusId) throws TwitterException;
     ...
     */
    TwitterFuture<ResponseList<User>> getRetweetedBy(long statusId) throws TwitterException;
     ...
     * @since Twitter4J 2.1.3
     */
    TwitterFuture<IDs> getRetweetedByIDs(long statusId) throws TwitterException;
}
