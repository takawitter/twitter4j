 ...
 */
public interface LegalResourcesGAEAsync {
    /**
     ...
     * @since Twitter4J 2.1.7
     */
	TwitterFuture<String> getTermsOfService() throws TwitterException;
     ...
     * @since Twitter4J 2.1.7
     */
	TwitterFuture<String> getPrivacyPolicy() throws TwitterException;
}
