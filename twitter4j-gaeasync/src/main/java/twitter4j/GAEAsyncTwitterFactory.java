 ...
 */
public final class GAEAsyncTwitterFactory implements java.io.Serializable {
     ...
     */
    public GAEAsyncTwitterFactory(Configuration conf) {
        if (conf == null) {
     ...
     */
    public GAEAsyncTwitterFactory(String configTreePath) {
     ...
     */
    public GAEAsyncTwitter getInstance() {
        return new GAEAsyncTwitterImpl(conf);
    }
     ...
     * Unlike {@link GAEAsyncTwitter#setOAuthAccessToken(twitter4j.auth.AccessToken)}, this factory method potentially returns a cached instance.
     *
     * @param accessToken access token
     * @return an instance
     */
    public GAEAsyncTwitter getInstance(AccessToken accessToken) {
        ...
        return new GAEAsyncTwitterImpl(conf, oauth);
    }
     ...
     * @return an instance
     */
    public GAEAsyncTwitter getInstance(Authorization auth) {
        return new GAEAsyncTwitterImpl(conf, auth);
    }
}
