 ...
 */
public class GAEAsyncTwitterTest extends GAEAsyncTwitterTestBase {

    public GAEAsyncTwitterTest(String name) {
        super(name);
    }
    ...
    public void testGetPublicTimeline() throws Exception {
        ...
        twitter1 = new GAEAsyncTwitterFactory(new ConfigurationBuilder().setOAuthConsumerKey(desktopConsumerKey)
        ...
        statuses = twitter1.getPublicTimeline().get();
    ...
    public void testGetHomeTimeline() throws Exception {
        List<Status> statuses = twitter1.getHomeTimeline().get();
    ...
    public void testGetFriendsTimeline() throws Exception {
        ...
        actualReturn = twitter1.getFriendsTimeline().get();
        assertTrue(actualReturn.size() > 0);
        actualReturn = twitter1.getFriendsTimeline(new Paging(1l)).get();
        assertTrue(actualReturn.size() > 0);
        //this is necessary because the twitter server's clock tends to delay
        actualReturn = twitter1.getFriendsTimeline(new Paging(1000l)).get();
        assertTrue(actualReturn.size() > 0);

        actualReturn = twitter1.getFriendsTimeline(new Paging(1)).get();
        assertTrue(actualReturn.size() > 0);
    ...
    public void testShowUser() throws Exception {
        User user = twitter1.showUser(id1.screenName).get();
        ...
        user = twitter1.showUser("tigertest").get();
        User previousUser = user;
        assertNotNull(DataObjectFactory.getRawJSON(user));

        user = twitter1.showUser(numberId).get();
        ...
        previousUser = user;
        user = twitter1.showUser(numberIdId).get();
        assertEquals(numberIdId, user.getId());
        assertNotNull(DataObjectFactory.getRawJSON(user));
        assertEquals(user, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user)));
    }
    ...
    public void testLookupUsers() throws TwitterException {
        ResponseList<User> users = twitter1.lookupUsers(new String[]{id1.screenName, id2.screenName}).get();
        assertEquals(2, users.size());
        assertContains(users, id1);
        assertContains(users, id2);

        users = twitter1.lookupUsers(new long[]{id1.id, id2.id}).get();
        assertEquals(2, users.size());
        assertContains(users, id1);
        assertContains(users, id2);
    ...
    public void testSearchUser() throws TwitterException {
        ResponseList<User> users = twitter1.searchUsers("Doug Williams", 1).get();
    ...
    public void testSuggestion() throws Exception {
        ResponseList<Category> categories = twitter1.getSuggestedUserCategories().get();
        ...
        ResponseList<User> users = twitter1.getUserSuggestions(categories.get(0).getSlug()).get();
        ...
        users = twitter1.getMemberSuggestions(categories.get(0).getSlug()).get();
        assertTrue(users.size() > 0);
    ...
    public void testProfileImage() throws Exception {
        ProfileImage image = twitter1.getProfileImage(id1.screenName, ProfileImage.BIGGER).get();
    ...
    public void testList() throws Exception {
        ...
        userLists = twitter1.getUserLists(id1.screenName, -1l).get();
        ...
        /*List Methods*/
        UserList userList;
        userList = twitter1.createUserList("testpoint1", false, "description1").get();
        ...
        userList = twitter1.updateUserList(userList.getId(), "testpoint2", true, "description2").get();
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        ...
        userList = twitter1.showUserList(id1.screenName, userList.getId()).get();
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        assertNotNull(userList);

        List<Status> statuses = twitter1.getUserListStatuses(id1.screenName, userList.getId(), new Paging()).get();
        if (statuses.size() > 0) {
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        }
        statuses = twitter1.getUserListStatuses(id1.id, userList.getId(), new Paging()).get();
        if (statuses.size() > 0) {
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        }
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        ...
        ResponseList<UserList> lists = twitter1.getAllUserLists(id1.id).get();
        assertTrue(0 < lists.size());
        lists = twitter1.getAllUserLists("yusukey").get();
        assertTrue(0 < lists.size());

        /*List Member Methods*/
        User user = null;
        try {
            user = twitter1.checkUserListMembership(id1.screenName, userList.getId(), id2.id).get();
            fail("id2 shouldn't be a member of the userList yet. expecting a TwitterException");
        } catch (TwitterException te) {
            assertEquals(404, te.getStatusCode());
        }
        userList = twitter1.addUserListMember(userList.getId(), id2.id).get();
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        userList = twitter1.addUserListMembers(userList.getId(), new long[]{id3.id, id2.id}).get();
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        userList = twitter1.addUserListMembers(userList.getId(), new String[]{"akr", "yusukey"}).get();
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        assertNotNull(userList);

        PagableResponseList<User> users = twitter1.getUserListMembers(id1.screenName, userList.getId(), -1).get();
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertNull(DataObjectFactory.getRawJSON(userList));
...
//        assertEquals(userList.getMemberCount(), users.size());
        ...
        users = twitter1.getUserListMembers(id1.id, userList.getId(), -1).get();
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertTrue(0 < users.size());

        userList = twitter1.deleteUserListMember(userList.getId(), id2.id).get();
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(userList);
        //
//        assertEquals(1, userList.getMemberCount());
        ...
        user = twitter1.checkUserListMembership(id1.screenName, userList.getId(), id3.id).get();
        assertNotNull(DataObjectFactory.getRawJSON(user));
        assertEquals(user, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user)));
        assertEquals(id3.id, user.getId());

        userLists = twitter1.getUserListMemberships(id1.screenName, -1l).get();
        assertNotNull(DataObjectFactory.getRawJSON(userLists));
        ...
        userLists = twitter1.getUserListSubscriptions(id1.screenName, -1l).get();
        assertNotNull(DataObjectFactory.getRawJSON(userLists));
        if (userLists.size() > 0) {
            assertEquals(userLists.get(0), DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userLists.get(0))));
        }
        ...
        users = twitter1.getUserListSubscribers(id1.screenName, userList.getId(), -1).get();
        assertNotNull(DataObjectFactory.getRawJSON(users));
...
//        assertEquals(1, users.size()); //only id4 should be subscribing the userList
        ...
        try {
            user = twitter1.checkUserListSubscription(id1.screenName, userList.getId(), id3.id).get();
            assertNotNull(DataObjectFactory.getRawJSON(user));
            assertEquals(user, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user)));
            assertEquals(id3.id, user.getId());
        } catch (TwitterException te) {
        ...
        userLists = twitter1.getUserListSubscriptions(id3.screenName, -1l).get();
        assertNotNull(userLists);
        if (userLists.size() > 0) {
            assertEquals(userLists.get(0), DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userLists.get(0))));
        }
//        assertEquals(1, userLists.size()); workarounding issue 1300
        ...
        try {
            user = twitter1.checkUserListSubscription(id1.screenName, userList.getId(), id2.id).get();
            fail("id2 shouldn't be a subscriber the userList. expecting a TwitterException");
        } catch (TwitterException ignore) {
            assertEquals(404, ignore.getStatusCode());
        }

        userList = twitter1.destroyUserList(userList.getId()).get();
        assertNotNull(DataObjectFactory.getRawJSON(userList));
        assertEquals(userList, DataObjectFactory.createUserList(DataObjectFactory.getRawJSON(userList)));
        assertNotNull(userList);
    }
    ...
    public void testUserTimeline() throws Exception {
        List<Status> statuses;
        statuses = twitter1.getUserTimeline().get();
        assertTrue("size", 0 < statuses.size());
        try {
            statuses = unauthenticated.getUserTimeline("1000").get();
            assertNotNull(DataObjectFactory.getRawJSON(statuses));
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
            assertTrue("size", 0 < statuses.size());
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
            ...
            statuses = unauthenticated.getUserTimeline(id1.screenName, new Paging().count(10)).get();
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
            assertNotNull(DataObjectFactory.getRawJSON(statuses));
            assertTrue("size", 0 < statuses.size());
            statuses = unauthenticated.getUserTimeline(id1.screenName, new Paging(999383469l)).get();
            assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
            assertNotNull(DataObjectFactory.getRawJSON(statuses));
            assertTrue("size", 0 < statuses.size());
        } catch (TwitterException te) {
        ...
        statuses = twitter1.getUserTimeline(new Paging(999383469l)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue("size", 0 < statuses.size());
        statuses = twitter1.getUserTimeline(new Paging(999383469l).count(15)).get();
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertTrue("size", 0 < statuses.size());


        statuses = twitter1.getUserTimeline(new Paging(1).count(30)).get();
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        List<Status> statuses2 = twitter1.getUserTimeline(new Paging(2).count(15)).get();
...
//        System.out.println(json.getString("text"));
        ...
        status = twitter2.showStatus(1000l).get();
        ...
        Status status2 = twitter1.showStatus(1000l).get();
    ...
    public void testStatusMethods() throws Exception {
        ...
        Status status = twitter1.updateStatus(date).get();
        assertNotNull(DataObjectFactory.getRawJSON(status));
        assertEquals(status, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status)));

        assertEquals(date, status.getText());
        Status status2 = twitter2.updateStatus(new StatusUpdate("@" + id1.screenName + " " + date).inReplyToStatusId(status.getId())).get();
        assertNotNull(DataObjectFactory.getRawJSON(status2));
        assertEquals(status2, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status2)));
        ...
        status = twitter1.destroyStatus(status.getId()).get();
        assertNotNull(DataObjectFactory.getRawJSON(status));
        assertEquals(status, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status)));
    }

    public void testRetweetMethods() throws Exception {
        List<Status> statuses = twitter1.getRetweetedByMe().get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedByMe(new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedByUser(id1.id, new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedByUser(id1.screenName, new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedToMe().get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedToMe(new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedToUser(id1.id, new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetedToUser(id1.screenName, new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetsOfMe().get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
//        assertIsRetweet(statuses);
        statuses = twitter1.getRetweetsOfMe(new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
//        assertIsRetweet(statuses);
        statuses = twitter1.getRetweets(18594701629l).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertIsRetweet(statuses);
        ...
        for (Status status : statuses) {
            if (null != status.getRetweetedStatus()) {
                List<User> users = twitter1.getRetweetedBy(status.getRetweetedStatus().getId()).get();
                assertNotNull(DataObjectFactory.getRawJSON(users));
                assertNotNull(DataObjectFactory.getRawJSON(users.get(0)));
                assertNotNull(users);
    ...
    public void testGeoLocation() throws Exception {
        ...
        Status withgeo = twitter1.updateStatus(new StatusUpdate(new java.util.Date().toString() + ": updating geo location").location(new GeoLocation(LATITUDE, LONGITUDE))).get();
        ...
        assertFalse(twitter2.verifyCredentials().get().isGeoEnabled());
    }
...
//    }
    ...
    public void testGetFriendsStatuses() throws Exception {
        PagableResponseList<User> users = twitter1.getFriendsStatuses(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertNotNull("friendsStatuses", users);

        users = twitter1.getFriendsStatuses(numberId, -1).get();
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertNotNull("friendsStatuses", users);
        ...
        try {
            users = unauthenticated.getFriendsStatuses("yusukey", -1).get();
            assertNotNull(DataObjectFactory.getRawJSON(users));
            assertNotNull("friendsStatuses", users);
            assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        } catch (TwitterException te) {
    ...
    public void testRelationship() throws Exception {
        ...
        Relationship rel1 = twitter1.showFriendship(id1.screenName, followsOneWay).get();
        ...
        Relationship rel2 = twitter1.showFriendship(bestFriend1.screenName, bestFriend2.screenName).get();
        ...
        // test equality
        Relationship rel3 = twitter1.showFriendship(id1.screenName, followsOneWay).get();
        ...
        ResponseList<Friendship> friendshipList = twitter1.lookupFriendships(new String[]{"barakobama", id2.screenName, id3.screenName}).get();
        ...
        friendshipList = twitter1.lookupFriendships(new long[]{id2.id, id3.id}).get();
        assertEquals(2, friendshipList.size());

        Relationship relationship = twitter1.updateFriendship(id3.screenName, true, true).get();
        assertEquals(id3.screenName, relationship.getTargetUserScreenName());

        relationship = twitter1.updateFriendship(id3.id, true, true).get();
        assertEquals(id3.screenName, relationship.getTargetUserScreenName());
    }
    ...
    public void testFriendships() throws Exception {
        IDs ids;
        ids = twitter3.getIncomingFriendships(-1).get();
        ...
        ids = twitter2.getOutgoingFriendships(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(ids));
        assertEquals(ids, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(ids)));
        assertTrue(ids.getIDs().length > 0);
        ids = twitter2.getNoRetweetIds().get();
        assertNotNull(DataObjectFactory.getRawJSON(ids));
        assertEquals(ids, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(ids)));
    ...
    public void testSocialGraphMethods() throws Exception {
        ...
        obamaFollowers = twitter1.getFollowersIDs("barackobama", obamaFollowers.getNextCursor()).get();
        assertEquals(obamaFollowers, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFollowers)));
        assertNotNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertTrue(obamaFollowers.hasNext());
        assertTrue(obamaFollowers.hasPrevious());

        obamaFollowers = twitter1.getFollowersIDs(813286, -1).get();
        assertNotNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertEquals(obamaFollowers, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFollowers)));
        assertTrue(obamaFollowers.hasNext());
        assertFalse(obamaFollowers.hasPrevious());
        obamaFollowers = twitter1.getFollowersIDs(813286, obamaFollowers.getNextCursor()).get();
        assertNotNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertEquals(obamaFollowers, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFollowers)));
        assertTrue(obamaFollowers.hasNext());
        assertTrue(obamaFollowers.hasPrevious());
        ...
        IDs obamaFriends;
        obamaFriends = twitter1.getFriendsIDs("barackobama", -1).get();
        ...
        obamaFriends = twitter1.getFriendsIDs("barackobama", obamaFriends.getNextCursor()).get();
        assertNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertNotNull(DataObjectFactory.getRawJSON(obamaFriends));
        assertEquals(obamaFriends, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFriends)));
        assertTrue(obamaFriends.hasNext());
        ...
        obamaFriends = twitter1.getFriendsIDs(813286, -1).get();
        assertNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertNotNull(DataObjectFactory.getRawJSON(obamaFriends));
        assertEquals(obamaFriends, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFriends)));
        assertTrue(obamaFriends.hasNext());
        assertFalse(obamaFriends.hasPrevious());
        obamaFriends = twitter1.getFriendsIDs(813286, obamaFriends.getNextCursor()).get();
        assertNull(DataObjectFactory.getRawJSON(obamaFollowers));
        assertNotNull(DataObjectFactory.getRawJSON(obamaFriends));
        assertEquals(obamaFriends, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(obamaFriends)));
        assertTrue(obamaFriends.hasNext());
        ...
        ids = twitter1.getFollowersIDs(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(ids));
        assertEquals(ids, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(ids)));
        assertIDExsits("twit4j2 is following twit4j", ids, 6377362);
        ids = twitter1.getFollowersIDs(ryunosukey, -1).get();
        assertNotNull(DataObjectFactory.getRawJSON(ids));
        assertEquals(ids, DataObjectFactory.createIDs(DataObjectFactory.getRawJSON(ids)));
    ...
    public void testAccountMethods() throws Exception {
        User original = twitter1.verifyCredentials().get();
        ...
        if (original.getScreenName().endsWith("new") ||
            ...
            original = twitter1.updateProfile(
                    ...
                    , "location:", "Hi there, I do test a lot!new").get();
        ...
        User altered = twitter1.updateProfile(
                newName, newURL, newLocation, newDescription).get();
        ...
        assertTrue(twitterAPIBestFriend1.existsFriendship(bestFriend1.screenName, bestFriend2.screenName).get());
        assertFalse(twitter1.existsFriendship(id1.screenName, "al3x").get());

        User eu;
        eu = twitter1.updateProfileColors("f00", "f0f", "0ff", "0f0", "f0f").get();
        ...
        eu = twitter1.updateProfileColors("87bc44", "9ae4e8", "000000", "0000ff", "e0ff92").get();
        assertNotNull(DataObjectFactory.getRawJSON(eu));
        assertEquals(eu, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(eu)));
        ...
        AccountTotals totals = twitter1.getAccountTotals().get();
        ...
        AccountSettings settings = twitter1.getAccountSettings().get();
    ...
    public void testAccountProfileImageUpdates() throws Exception {
        User user = twitter1.updateProfileImage(new FileInputStream(getRandomlyChosenFile())).get();
        assertNotNull(DataObjectFactory.getRawJSON(user));
        // tile randomly
        User user2 = twitter1.updateProfileBackgroundImage(getRandomlyChosenFile(),
                (5 < System.currentTimeMillis() % 5)).get();
    ...
    public void testFavoriteMethods() throws Exception {
        Status status = twitter1.getHomeTimeline(new Paging().count(1)).get().get(0);
        assertNotNull(DataObjectFactory.getRawJSON(status));
        assertEquals(status, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status)));
        status = twitter2.createFavorite(status.getId()).get();
        assertNotNull(DataObjectFactory.getRawJSON(status));
        assertEquals(status, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status)));
        assertTrue(twitter2.getFavorites().get().size() > 0);
        try {
    ...
    public void testFollowers() throws Exception {
        PagableResponseList<User> actualReturn = twitter1.getFollowersStatuses(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(actualReturn.get(0))));
        assertTrue(actualReturn.size() > 0);
        actualReturn = twitter1.getFollowersStatuses(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(actualReturn.get(0))));
        assertTrue(actualReturn.size() > 0);
        assertFalse(actualReturn.hasNext());
        assertFalse(actualReturn.hasPrevious());
        actualReturn = twitter1.getFollowersStatuses(actualReturn.getNextCursor()).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(0, actualReturn.size());

        actualReturn = twitter2.getFollowersStatuses(-1).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(actualReturn.get(0))));
        assertTrue(actualReturn.size() > 0);
        actualReturn = twitter2.getFollowersStatuses("yusukey", -1).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(actualReturn.get(0))));
        assertTrue(actualReturn.size() > 60);
        actualReturn = twitter2.getFollowersStatuses("yusukey", actualReturn.getNextCursor()).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(actualReturn.get(0))));
...
//        assertTrue(actualReturn.size() > 10);
    ...
    public void testDirectMessages() throws Exception {
        ...
        DirectMessage actualReturn = twitter1.sendDirectMessage("twit4jnoupdate", expectedReturn).get();
        ...
        List<DirectMessage> actualReturnList = twitter1.getDirectMessages().get();
        ...
        actualReturn = twitter1.showDirectMessage(actualReturnList.get(0).getId()).get();
        assertNotNull(DataObjectFactory.getRawJSON(actualReturn));
        assertEquals(actualReturn, DataObjectFactory.createDirectMessage(DataObjectFactory.getRawJSON(actualReturn)));
    ...
    public void testCreateDestroyFriend() throws Exception {
        User user;
        try {
            user = twitter2.destroyFriendship(id1.screenName).get();
            assertNotNull(DataObjectFactory.getRawJSON(user));
            assertEquals(user, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user)));
        } catch (TwitterException te) {
        ...
        user = twitter2.createFriendship(id1.screenName, true).get();
        assertNotNull(DataObjectFactory.getRawJSON(user));
        assertEquals(user, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user)));
        assertEquals(id1.screenName, user.getScreenName());
...
//        assertTrue(detail.isNotificationEnabled());
        try {
            user = twitter2.createFriendship(id2.screenName).get();
            fail("shouldn't be able to befrinend yourself");
        } catch (TwitterException te) {
            assertEquals(403, te.getStatusCode());
        }
        try {
            user = twitter2.createFriendship("doesnotexist--").get();
    ...
    public void testGetMentions() throws Exception {
        Status status = twitter2.updateStatus("@" + id1.screenName + " reply to id1 " + new java.util.Date()).get();
        assertNotNull(DataObjectFactory.getRawJSON(status));
        List<Status> statuses = twitter1.getMentions().get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue(statuses.size() > 0);

        statuses = twitter1.getMentions(new Paging(1)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue(statuses.size() > 0);
        statuses = twitter1.getMentions(new Paging(1)).get();
        ...
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue(statuses.size() > 0);
        statuses = twitter1.getMentions(new Paging(1, 1l)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue(statuses.size() > 0);
        statuses = twitter1.getMentions(new Paging(1l)).get();
        assertNotNull(DataObjectFactory.getRawJSON(statuses));
        assertEquals(statuses.get(0), DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(statuses.get(0))));
        assertTrue(statuses.size() > 0);
    }
    ...
    public void testNotification() throws Exception {
        ...
        User user1 = twitter1.enableNotification("twit4jprotected").get();
        ...
        User user2 = twitter1.disableNotification("twit4jprotected").get();
        assertNotNull(DataObjectFactory.getRawJSON(user2));
        assertEquals(user2, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user2)));
    }

    public void testBlock() throws Exception {
        User user1 = twitter2.createBlock(id1.screenName).get();
        assertNotNull(DataObjectFactory.getRawJSON(user1));
        assertEquals(user1, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user1)));
        User user2 = twitter2.destroyBlock(id1.screenName).get();
        assertNotNull(DataObjectFactory.getRawJSON(user2));
        assertEquals(user2, DataObjectFactory.createUser(DataObjectFactory.getRawJSON(user2)));
        assertFalse(twitter1.existsBlock("twit4j2").get());
        assertTrue(twitter1.existsBlock("twit4jblock").get());
        List<User> users = twitter1.getBlockingUsers().get();
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertEquals(1, users.size());
        assertEquals(39771963, users.get(0).getId());
        users = twitter1.getBlockingUsers(1).get();
        assertNotNull(DataObjectFactory.getRawJSON(users));
        assertEquals(users.get(0), DataObjectFactory.createUser(DataObjectFactory.getRawJSON(users.get(0))));
        assertEquals(1, users.size());
        assertEquals(39771963, users.get(0).getId());

        IDs ids = twitter1.getBlockingUsersIDs().get();
    ...
    public void testLocalTrendsMethods() throws Exception {
        ...
        locations = twitter1.getAvailableTrends().get();
        ...
        locations = twitter1.getAvailableTrends(new GeoLocation(0, 0)).get();
        assertNotNull(DataObjectFactory.getRawJSON(locations));
        assertTrue(locations.size() > 0);

        Trends trends = twitter1.getLocationTrends(locations.get(0).getWoeid()).get();
        ...
        try {
            trends = twitter1.getLocationTrends(2345889/*woeid of Tokyo*/).get();
            fail("should fail.");
    ...
    public void testRateLimitStatus() throws Exception {
        RateLimitStatus rateLimitStatus = twitter1.getRateLimitStatus().get();
        ...
        twitter1.addRateLimitStatusListener(new RateLimitStatusListener() {
            public void onRateLimitStatus(RateLimitStatusEvent event) {
                ...
                GAEAsyncTwitterTest.this.rateLimitStatus = event.getRateLimitStatus();
            }
    ...
    public void testSavedSearches() throws Exception {
        List<SavedSearch> list = twitter1.getSavedSearches().get();
        ...
        SavedSearch ss1 = twitter1.createSavedSearch("my search").get();
        ...
        list = twitter1.getSavedSearches().get();
        assertNotNull(DataObjectFactory.getRawJSON(list));
        ...
        try {
            SavedSearch ss2 = twitter1.destroySavedSearch(ss1.getId()).get();
    ...
    public void testGeoMethods() throws Exception {
        ...
        places = twitter1.reverseGeoCode(query).get();
        ...
        places = twitter1.searchPlaces(query).get();
        assertNotNull(DataObjectFactory.getRawJSON(places));
        assertEquals(places.get(0), DataObjectFactory.createPlace(DataObjectFactory.getRawJSON(places.get(0))));
        assertTrue(places.size() > 0);
        places = twitter1.getSimilarPlaces(new GeoLocation(37.78215, -122.40060), "SoMa", null, null).get();
        assertNotNull(DataObjectFactory.getRawJSON(places));
        assertEquals(places.get(0), DataObjectFactory.createPlace(DataObjectFactory.getRawJSON(places.get(0))));
        assertTrue(places.size() > 0);

        try {
            Place place = this.unauthenticated.getGeoDetails("5a110d312052166f").get();
    ...
    public void testRelatedResults() throws Exception {
        RelatedResults relatedResults = twitter1.getRelatedResults(999383469l).get();
    ...
    public void testTest() throws Exception {
        assertTrue(unauthenticated.test().get());
    }

    public void testEntities() throws Exception {
        Status status = twitter2.showStatus(25733871525957632l).get();
        assertNotNull(DataObjectFactory.getRawJSON(status));
        assertEquals(status, DataObjectFactory.createStatus(DataObjectFactory.getRawJSON(status)));
